...
public class Menu3 extends javax.swing.JFrame {
    Lista listaJugadoresZombie = new Lista("Jugador Zombie");

    private static Object jugadorZombies;
    private static int cantidadZombies;
    private static int fichasZombies;
   
    public Menu3() {
        initComponents();
    }

    public static Object obtenerJugadorZombies()
    {
    return jugadorZombies;
    }
    
    public static int obtenerCantidadZombies()
    {
    return cantidadZombies;
    }
    
    public static int obtenerFichasZombies()
    {
    return fichasZombies;
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Practica1_200715103/Zombies Img/Avatar.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        jugadorZombies = objetoNombre;
        cantidadZombies = objetoCantidad;
        fichasZombies = objetoFichas;
        
        
        listaJugadoresZombie.insertarAlFinal(objetoNombre, objetoCantidad, objetoFichas);
        listaJugadoresZombie.imprimir();
